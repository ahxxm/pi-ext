...
Known limit: 1. model prior too strong, the rewrite still starts with "Fair" and ends with a redundant summary line; 2. model justifies itself; 3. prefix stability due to strict:true, only affects claude models(see TODOs and `resolveJsonSchemaStrictSampling`) 
